...
class Test_SolarApp_Sharvani(unittest.TestCase):
    ...
    def test_DaysToCompute(self):
        ...
        days_To_Compute_Output = SolarApp_Sharvani.Days_To_Compute(days_To_Compute_Input)
    ...
    def test_Declination(self):
        ...
        self.assertEqual(np.size(declination_Output[0]), np.size(declination_Input[0]))
    ...
    def test_GHIGauSinAvg(self):
        ...
        ghi_Gau_Sin_Avg_Output = SolarApp_Sharvani.GHI_Gau_Sin_Avg(ghi_Gau_Sin_Avg_Input)
