...
if (isappdata(0,'Wind_GUI_MainPage')) % Wind_Power_Curve_Graph_GUI is opened with Wind App
    
    % Getting AllParameters from relevant GUI Workspace
    ...
    WTGGenCleanAlgorithm=0; % Intializing
    
elseif (isappdata(0,'Data_PreProcSys_GUI')) % Wind_Power_Curve_Graph_GUI is opened with Data PreProc App
    ...
    ComputationOptionsMenu=0; % Initializing
end
...
% Disintegrating Parameters_T Cells for Power_T
...
elseif (ForecastMode==1) % Forecast Mode is Selected
    ...
    if ((ComputationOptionsMenu==2)||(WTGGenCleanAlgorithm==2)) % Getting Standard Power Curves per Sub Model Type
    ...
    elseif ((ComputationOptionsMenu==3)||(WTGGenCleanAlgorithm==3)) % Getting Real Averaged Power Curves per Turbine
    ...
    elseif ((ComputationOptionsMenu==4)||(WTGGenCleanAlgorithm==4)) % Getting Real Averaged Power Curve for the Plant Level
