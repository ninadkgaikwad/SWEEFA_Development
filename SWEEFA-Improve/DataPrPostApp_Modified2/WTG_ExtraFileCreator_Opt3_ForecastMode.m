function [WTG_ExtraFile_Cell]=WTG_ExtraFileCreator_Opt3_ForecastMode(PlantCleanedFile_Cell,FileType,GenIrrad,Res,Filename,AllParameters,WindLossParameters)
