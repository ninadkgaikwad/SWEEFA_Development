function [ DTIrradiance_Cleaned_Cell ] = SolarPVIrradianceDataCleaner_ForecastMode( DTIrradiance_Cell,Res,Lat,GenIrrad,WeatherFileHourlyOrRes,PlantInfo_Parameters,SheetNum,SheetType )

%% Function Details:

% DTIrradiance_Cell = Date-Time and Irradiance Columns with Headers in a Cell Structure
...
%% Cleaning Solar PV Irradiance Variable Data Column

%% Preliminary Computations

% Computing DataCols and Rows

[r,c]=size(DTIrradiance_Cell);
...
ProcessedData=cell2mat(DTIrradiance_Cell(2:end,:));
...
%% Creating DTIrradiance_Cleaned_Cell

DTIrradiance_Cleaned_Cell=vertcat(DTIrradiance_Cell(1,:),mat2cell(ProcessedData));
