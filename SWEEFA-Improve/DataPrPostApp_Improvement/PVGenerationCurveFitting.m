function [ ProcessedData ] = PVGenerationCurveFitting( ProcessedData,Day,Col,Res,Lat,n,Index )
%UNTITLED Summary of this function goes here
%   Detailed explanation goes here

% Getting NanCheck and ZeroCheck from Index
...
CorrectionRows1=NaNCheck1+(DayDataPoints*(Day-1));

CorrectionRows=intersect(TT,CorrectionRows1);
