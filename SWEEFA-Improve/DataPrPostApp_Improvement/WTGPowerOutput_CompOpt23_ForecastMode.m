function [WTGPowerTotal, WTGPowerPR  ] = WTGPowerOutput_CompOpt23_ForecastMode( WTGPower, WTGNum, Perf_Rat, Turbine_File, PR, ActiveTurbines  )
...
elseif (Turbine_File==1)
        ...
        WTGPowerPR = WTGPower*(ActiveTurbines);
