function [WindSpeed_PlantLevel_Column_New,Power_PlantLevel_Column_New]=WTG_PlantLevel_WindSpeedPowerColumn_Generator_Opt2(WindSpeed_PlantLevel_Column,Power_PlantLevel_Column,AllParameters,Type,WTG_Type)
...
if (Type==1) % Plant-Level 
    ...
    if (T1==1) % WTG Type1 is Present
        ...
        for i=1:sub_T1
            ...
            PowerCurve(:,end)=PowerCurve(:,end)*subnum_T1(1,i);
    ...
    if (T2==1) % WTG Type2 is Present
        ...
        for i=1:sub_T2
            ...
            PowerCurve(:,end)=PowerCurve(:,end)*subnum_T2(1,i);
    ...
    if (T3==1) % WTG Type3 is Present
        ...
        for i=1:sub_T3
            ...
            PowerCurve(:,end)=PowerCurve(:,end)*subnum_T3(1,i);
    ...
    if (T4==1) % WTG Type4 is Present
        ...
        for i=1:sub_T4
            ...
            PowerCurve(:,end)=PowerCurve(:,end)*subnum_T4(1,i);
