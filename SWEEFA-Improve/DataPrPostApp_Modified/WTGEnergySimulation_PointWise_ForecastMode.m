function [WTG_Generation] = WTGEnergySimulation_PointWise_ForecastMode( WindSpeedMeasured, TemperatureMeasured,PlantStatus, Hres,EnergyOrPower,AllParameters_Disintegrated_Cell,WindLossParameters,WTGGenCleanAlgorithm)
