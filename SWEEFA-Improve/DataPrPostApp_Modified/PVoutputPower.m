function [ PVout,INVpin,INVpout,Pgrid,ArrayMismatchLoss,ShadingLoss,LIDLoss,OhmicLossP,InverterLoss,TransformerLossP ] = PVoutputPower( Pmodtot, LID,LS,Arraymismat,Crys,Shading, OhmicLoss,INVeff,TransLoss )
