function [ SummationDataMatrix ] = WindEnergySummationOfExcelFiles( Type , DataSeriesNumVector)
...
% DataSeriesNumVector=[1,4,6]; % Can be a single data series or more
...
for i=1:numOfSheets
    ...
    [DataAcquired(:,:,i)]=xlsread(Fullpathname,i);
...
DataNames={'WTGOutEnergy','WTGPowerGridEnergy','WTGOhmicLossEnergy','WTGTransLossEnergy'};
...
if (Type==1) % Intra-Day
    ...
    filename = 'WindPlantSummationEnergy_IntraDay_File.xlsx';
...
elseif (Type==2) % Daily
   ...
   xlRange1='D1';
    ...
    filename = 'WindPlantSummationEnergy_Daily_File.xlsx';
...
elseif (Type==3) % Monthly
   ...
   filename = 'WindPlantSummationEnergy_Monthly_File.xlsx';
