function [ ProcessedData ] = WindEnergySum_MultiExcelFiles( FileTypeNum,DataSeriesNumVector )
...
for i=1:Len1
    ...
    [ SummationDataMatrix ] = WindEnergySummationOfExcelFiles_1(ExcelFileData{1,i}, TypeVector(1,TypeVectorIndex) , DataSeriesNumVector);
