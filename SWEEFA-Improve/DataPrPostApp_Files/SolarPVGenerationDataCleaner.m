function [ ProcessedData,Z,N ] = SolarPVGenerationDataCleaner( Headers,Res,DataCols,hem,Ltm,L,Lat,GenCapacity,GenIrrad, WeatherFileHourlyOrRes, DataCumulativeOrNot, PlantInfo_Parameters )
...
for i=1:TotDays
    ...
    for k=1:DataCols
        ...
        elseif PercentUnknownValues>30 % Use PV Energy Evaluation Model to fill missing DATA
            
            Index=[NaNCheck,ZeroCheck];
            
            [ProcessedData, PgridEnergy,Irradiance] = SolarPVEnergySimulationPointWiseSim1(ProcessedData,GenIrrad,WeatherFileHourlyOrRes,n,Index,i,k,Lat,Pmod,PVTech,ModNum,ModTemCF,SF,LID,LS,Arraymismat,OhmicLoss,rho,INVeff,TransLoss,Uo,U1,Shading,bo,Temp,WS,OrientationType,OrientationParameters,Years,RainSnowMonths,yr,mr,YearRain,MonthRain,Res) ;
            
        elseif PercentUnknownValues<=30 % Use CurveFitting Method by Gauss1
...
filename = [Filename,'_Processed_Generation_File.xlsx'];
