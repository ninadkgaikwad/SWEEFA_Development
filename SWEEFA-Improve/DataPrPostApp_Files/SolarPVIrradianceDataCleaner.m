function [ ProcessedData,Z,N ] = SolarPVIrradianceDataCleaner( Headers,Res,DataCols,hem,Ltm,L,Lat,GenIrrad,PlantInfo_Parameters )
...
for i=1:TotDays
    ...
    for k=1:DataCols
        ...
        elseif ((PercentUnknownValues<=30)&&(PercentUnknownValues>0)) % Use CurveFitting Method by Gauss1
...
filename = [Filename,'_Processed_Irradiance_File.xlsx'];
