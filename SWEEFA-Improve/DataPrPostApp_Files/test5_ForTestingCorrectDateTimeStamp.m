% Use this first for checking Time Stamp Irregularities (as everything else depends on correct TimeStamp Consistency)
...
GenCapacity=[100,100,100,100,100];
...
filename = 'Generation_Irradiance_File.xlsx';
