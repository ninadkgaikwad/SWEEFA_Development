function [ ClearIndex,DiffIndex] = ClearnessIndex( RainSnowMonths,yr,mr,YearRain,MonthRain,LeapYear,NormalClearSky,ModifiedClearSky )
...
elseif (NormalClearSky==1)
    
    if (LeapYear==0)
        
        Year=1:365;
        
        ClearIndex=ones(1,length(Year));
        
        DiffIndex=zeros(1,length(Year));
