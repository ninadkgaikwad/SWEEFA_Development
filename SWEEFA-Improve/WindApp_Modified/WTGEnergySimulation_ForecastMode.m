    ...
    if (T1==1) % WTG Type 1 is Selected
        ...
        for i=1:subnum_Total_T1 % For Each Weather File
           ...
           for j=1:Row % For each Date-Time Stamp
                ...
                [WTGPowerTotal, WTGPowerPR  ] = WTGPowerOutput_CompOpt4_ForecastMode( WTGPowerPointCorrected, subnum_Total_T1, Perf_Rat, Turbine_File, PR, PlantStatus(j,1,WeatherFile_Index)  );
    ...
    if (T2==1) % WTG Type 2 is Selected
        ...
        for i=1:subnum_Total_T1 % For Each Weather File
           ...
           for j=1:Row % For each Date-Time Stamp
                ...
                [WTGPowerTotal, WTGPowerPR  ] = WTGPowerOutput_CompOpt4_ForecastMode( WTGPowerPointCorrected, subnum_Total_T2, Perf_Rat, Turbine_File, PR, PlantStatus(j,1,WeatherFile_Index)  );
    ...
    if (T3==1) % WTG Type 3 is Selected
        ...
        for i=1:subnum_Total_T3 % For Each Weather File
           ...
           for j=1:Row % For each Date-Time Stamp
                ...
                [WTGPowerTotal, WTGPowerPR  ] = WTGPowerOutput_CompOpt4_ForecastMode( WTGPowerPointCorrected, subnum_Total_T3, Perf_Rat, Turbine_File, PR, PlantStatus(j,1,WeatherFile_Index)  );
