...
elseif (ForecastMode==1) % Forecast Mode is Selected
    ...
    if ((ComputationOptionsMenu==2)||(WTGGenCleanAlgorithm==1)) % Getting Standard Power Curves per Sub Model Type
    ...
    elseif ((ComputationOptionsMenu==3)||(WTGGenCleanAlgorithm==2)) % Getting Real Averaged Power Curves per Turbine
    ...
    elseif ((ComputationOptionsMenu==4)||(WTGGenCleanAlgorithm==3)) % Getting Real Averaged Power Curve for the Plant Level
