...
echo ""
echo ""
echo -e "Enter your Data Folder Name  : \c"
read Unam1
echo ""
echo ""

cd /home/$Unam/Build_WRF/$Unam1
...
do
	...
	curl -s --disable-epsv  -u anonymous:USER_ID@INSTITUTION -o GFS_24h ftp://ftpprd.ncep.noaa.gov/pub/data/nccf/com/gfs/prod/gfs.$InitDateTime/gfs.t00z.pgrb2.0p50.f024
...
echo -e "Can you see GFS_00h , GFS_06h , GFS_12h , GFS_18h, GFS_24h between the Asterix Lines ? [y/n] : \c"
read Ans
if [ $Ans = "Y" -o $Ans = "y" ]
